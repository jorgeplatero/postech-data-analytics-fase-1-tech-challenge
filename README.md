...
| :--- | :--- | :--- | :--- |
| **Frontend/App** | **Streamlit** | `1.32.2` | Framework utilizado para o desenvolvimento do dashboard interativo |
...
Link para o aplicativo: https://postechtechchallengefase1-nzyixopq8dxumqrhuvfe7r.streamlit.app/
